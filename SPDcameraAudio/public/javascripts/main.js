...
var socket = io();
var mainServer = io('//192.168.86.46:3000/');

var mainLayOutHTML = "<div class='container mainContainer'>"+
                        "<div class='row'>"+
                          "<div class='col-5 col-md-5 customBox topRow'>.col-6 .col-md-4</div>"+
                          "<div class='col-5 col-md-6 customBox  topRow'>.col-6 .col-md-4</div>"+
                        "</div>"+
                        "<div class='row'>"+
         ...
         mainServer.on('audioLevels', function(data) {
           ...
           if(soundRIGHTDiff<0){
            soundRIGHTDiff = 0;
              ...
              soundCENTER = data[1];
              soundRIGHT = data[2];
              var dataDiff = [soundLEFTDiff,soundCENTERDiff,soundRIGHTDiff]
          var label = ['LEFT','CENTER','RIGHT']
            ...
            console.log(data.streams[0].width)
              console.log(data.format.duration)
                ...
                $('#videoPlayer').html("<video width='1024' height='600' controls>"+
                        "<source src='http://192.168.196.75:3000/videos/" +clickedVideo + "' type='video/mp4'>"+
